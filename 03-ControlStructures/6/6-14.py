...
# Facebook, Twitter or Instagram. Use logical type variables: facebook, twitter, instagram, 
...
number_of_accs = facebook + twitter + instagram

if number_of_accs >= 2:
    print("You are a good influencer")
else:
    print("Step up your game homie")